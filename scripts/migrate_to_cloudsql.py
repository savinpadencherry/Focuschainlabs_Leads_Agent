...
Usage:
    ...
    python scripts/migrate_to_cloudsql.py            # migrate data/crm/contacts.json
...
def main() -> int:
    ...
    upserted = pg.bulk_upsert(contacts, merge_mobile_fields=False)
    after = pg.count_contacts()
